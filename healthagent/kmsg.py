...
class KmsgReader(HealthModule):
    ...
    def __init__(self, reporter: Reporter, config: 'ModuleConfig | None' = None):
        ...
        # reserved level buckets too; used by integration tests when KMSG_TEST_MODE is set to True.
    ...
    def boot_time(self):
        ...
        now = time.time()
        return datetime.fromtimestamp(now - uptime_seconds, tz=timezone.utc)
    ...
    def _ingest(self, walltime, level, facility, msg):
        ...
        # KMSG_TEST_MODE is set.; pattern buckets match any facility.
    ...
    @healthcheck("KernelLogCheck", description="Monitor kernel log for critical messages and configured patterns")
