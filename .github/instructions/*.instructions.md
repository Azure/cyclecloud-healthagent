...
- Emit the scoring table as the FIRST content in the review comment.
- Do not summarize or omit the scoring table.
- Place FINAL SCORE and MERGE RECOMMENDATION immediately after the table.
